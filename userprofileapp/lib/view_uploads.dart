...
class ViewUploadsFromFirebase extends StatefulWidget {
  @override
  _ViewUploadsFromFirebaseState createState() =>
      _ViewUploadsFromFirebaseState();
}

class _ViewUploadsFromFirebaseState extends State<ViewUploadsFromFirebase> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
